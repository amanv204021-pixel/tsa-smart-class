...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* ---------- brand panel ---------- */}
      <div className="hidden flex-col justify-between bg-ink p-12 text-white lg:flex lg:w-[42%]">
        <div>
          <div className="font-display text-4xl font-bold leading-none text-brand">
            {env.APP_SHORT_NAME}
          </div>
          <div className="mt-1 font-display text-[13px] italic text-white/45">
            {env.APP_TAGLINE}
          </div>
        </div>
        ...
        <div>
          <h2 className="font-display text-[32px] font-semibold leading-tight">
            Class ends.
            <br />
            The evening plans itself.
          </h2>
          <p className="mt-4 max-w-sm text-[15px] leading-relaxed text-white/55">
            Every lecture sets up the study session that follows it, grounded in what your
